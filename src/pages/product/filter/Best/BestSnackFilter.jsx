...
const BestSnackFilter = () => {
    ...
    // const clickSort = location.state?.clickSort;
        ...
        const getProduct = async () => {
            const response = await fetch(`http://localhost:8000/product/get?categories=간식과일견과&tag=BEST&clickSort=${clickSort}`)
...
export default BestSnackFilter;