...
const BestSpiceFilter = () => {
    ...
    // const clickSort = location.state?.clickSort;
        ...
        const getProduct = async () => {
            const response = await fetch(`http://localhost:8000/product/get?categories=양념가루&tag=BEST&clickSort=${clickSort}`)
...
export default BestSpiceFilter;