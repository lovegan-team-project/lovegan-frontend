...
const SaleSpiceFilter = () => {
    ...
    // const clickSort = location.state?.clickSort;
        ...
        const getProduct = async () => {
            const response = await fetch(`http://localhost:8000/product/get?categories=양념가루&tag=SALE&clickSort=${clickSort}`)
...
export default SaleSpiceFilter;