...
const SaleVegeSideFilter = () => {
    ...
    // const clickSort = location.state?.clickSort;
        ...
        const getProduct = async () => {
            const response = await fetch(`http://localhost:8000/product/get?categories=채식반찬&tag=SALE&clickSort=${clickSort}`)
...
export default SaleVegeSideFilter;