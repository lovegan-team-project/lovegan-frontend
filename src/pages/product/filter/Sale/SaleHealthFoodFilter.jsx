...
const SaleHealthFoodFilter = () => {
    ...
    // const clickSort = location.state?.clickSort;
        ...
        const getProduct = async () => {
            const response = await fetch(`http://localhost:8000/product/get?categories=건강식품&tag=SALE&clickSort=${clickSort}`)
...
export default SaleHealthFoodFilter;