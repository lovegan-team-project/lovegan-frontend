...
const SaleFastfoodFilter = () => {
    ...
    // const clickSort = location.state?.clickSort;
        ...
        const getProduct = async () => {
            const response = await fetch(`http://localhost:8000/product/get?categories=간편식&tag=SALE&clickSort=${clickSort}`)
...
export default SaleFastfoodFilter;